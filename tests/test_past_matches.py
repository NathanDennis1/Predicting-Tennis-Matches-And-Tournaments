...
class TestPastMatchData:
    ...
    def test_return_type(self, past_match, sample_data):
        ...
        # Check that the return value is a tuple with two dataframes
    ...
    def test_index_names(self, past_match, sample_data):
        ...
        # Check that both dataframes have 'Player_Name' as index name
    ...
    def test_data_integrity(self, past_match, sample_data):
        """
        Test that the values in the dataframes are correct.
        """
        win_percentage_df, games_played_df = past_match.win_percentage_common_opponents(sample_data)
        
        # Check if the win_percentage_df contains expected data
        ...
        # Check if games_played_df contains expected data
